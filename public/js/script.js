!(function () {
        ...
        for (let n = 1; n < e.length; n += 1) {
            ...
            if (null != r && ((i = r), !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                ...
                for (let s = 0, i = e.length; s < i; s += 1) {
                    ...
                    void 0 !== n && n.enumerable && (v(t[i]) && v(r[i]) ? (r[i].__swiper__ ? (t[i] = r[i]) : g(t[i], r[i])) : !v(t[i]) && v(r[i]) ? ((t[i] = {}), r[i].__swiper__ ? (t[i] = r[i]) : g(t[i], r[i])) : (t[i] = r[i]));
                }
            }
        }
        var i;
        ...
        y = {
            ...
            updateSlides: function () {
                ...
                "string" == typeof T && T.indexOf("%") >= 0 && (T = (parseFloat(T.replace("%", "")) / 100) * r),
                    (e.virtualSize = -T),
                    a ? c.css({marginLeft: "", marginBottom: "", marginTop: ""}) : c.css({
                        marginRight: "",
                        marginBottom: "",
                        marginTop: ""
                    }),
                ...
                for (let n = 0; n < p; n += 1) {
                    ...
                    if ((x && e.grid.updateSlide(n, a, p, t), "none" !== a.css("display"))) {
                        if ("auto" === i.slidesPerView) {
                            ...
                            if ((o && (a[0].style.transform = "none"), l && (a[0].style.webkitTransform = "none"), i.roundLengths)) y = e.isHorizontal() ? a.outerWidth(!0) : a.outerHeight(!0);
                            else {
                                const e = s(r, "width"),
                                    t = s(r, "padding-left"),
                                    i = s(r, "padding-right"),
                            ...
                            o && (a[0].style.transform = o), l && (a[0].style.webkitTransform = l), i.roundLengths && (y = Math.floor(y));
                        } else (y = (r - (i.slidesPerView - 1) * T) / i.slidesPerView), i.roundLengths && (y = Math.floor(y)), c[n] && (c[n].style[t("width")] = `${y}px`);
                        c[n] && (c[n].swiperSlideSize = y),
                            ...
                            i.centeredSlides
                                ...
                                C % i.slidesPerGroup == 0 && u.push(S),
                                    h.push(S))
                                : (i.roundLengths && (S = Math.floor(S)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && u.push(S), h.push(S), (S = S + y + T)),
                            (e.virtualSize += y + T),
                            (E = y),
                            (C += 1);
                    }
                ...
                if ((0 === u.length && (u = [0]), 0 !== i.spaceBetween)) {
                    ...
                    c.filter((e, t) => !i.cssMode || t !== c.length - 1).css({[s]: `${T}px`});
                }
            ...
            updateClickedSlide: function (e) {
                ...
                (t.clickedSlide = i),
                    t.virtual && t.params.virtual.enabled ? (t.clickedIndex = parseInt(h(i).attr("data-swiper-slide-index"), 10)) : (t.clickedIndex = n),
    ...
    var M = {
        slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
            ...
            let w;
            if ((a !== (c || 0) && s && r.emit("beforeSlideChangeStart"), r.updateProgress(g), (w = a > p ? "next" : a < p ? "prev" : "reset"), (u && -g === r.translate) || (!u && g === r.translate)))
                return r.updateActiveIndex(a), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== o.effect && r.setTranslate(g), "reset" !== w && (r.transitionStart(s, w), r.transitionEnd(s, w)), !1;
            if (o.cssMode) {
        ...
        slidePrev: function (e = this.params.speed, t = !0, s) {
            ...
            if (
                (void 0 !== h &&
                ((f = o.indexOf(h)), f < 0 && (f = i.activeIndex - 1), "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && ((f = f - i.slidesPerViewDynamic("previous", !0) + 1), (f = Math.max(f, 0)))),
    ...
    function P(e) {
        ...
        if (!s.allowTouchMove) return h(d.target).is(n.focusableElements) || (s.allowClick = !1), void (n.isTouched && (Object.assign(a, {
            startX: p,
            startY: u,
            currentX: p,
            currentY: u
        ...
        if (void 0 === n.isScrolling) {
            ...
            (s.isHorizontal() && a.currentY === a.startY) || (s.isVertical() && a.currentX === a.startX)
                ? (n.isScrolling = !1)
                : f * f + v * v >= 25 && ((e = (180 * Math.atan2(Math.abs(v), Math.abs(f))) / Math.PI), (n.isScrolling = s.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle));
        }
        ...
        if (
            (r.touchReleaseOnEdges && (b = 0),
                g > 0 && n.currentTranslate > s.minTranslate()
                    ? ((w = !1), r.resistance && (n.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + n.startTranslate + g) ** b))
                    : g < 0 && n.currentTranslate < s.maxTranslate() && ((w = !1), r.resistance && (n.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - n.startTranslate - g) ** b)),
            w && (d.preventedByNestedSwiper = !0),
            !s.allowSlideNext && "next" === s.swipeDirection && n.currentTranslate < n.startTranslate && (n.currentTranslate = n.startTranslate),
            !s.allowSlidePrev && "prev" === s.swipeDirection && n.currentTranslate > n.startTranslate && (n.currentTranslate = n.startTranslate),
            ...
            if (!n.allowThresholdMove)
                return (n.allowThresholdMove = !0), (a.startX = a.currentX), (a.startY = a.currentY), (n.currentTranslate = n.startTranslate), void (a.diff = s.isHorizontal() ? a.currentX - a.startX : a.currentY - a.startY);
        }
        r.followFinger &&
        !r.cssMode &&
    ...
    function $(e) {
        ...
        if (c > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (w >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? v : u + b) : t.slideTo(u)),
            "prev" === t.swipeDirection && (w > 1 - i.longSwipesRatio ? t.slideTo(u + b) : null !== g && w < 0 && Math.abs(w) > i.longSwipesRatio ? t.slideTo(g) : t.slideTo(u));
        } else {
            if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
            !t.navigation || (l.target !== t.navigation.nextEl && l.target !== t.navigation.prevEl)
                ? ("next" === t.swipeDirection && t.slideTo(null !== v ? v : u + b), "prev" === t.swipeDirection && t.slideTo(null !== g ? g : u))
    ...
    const G = (e, t) => {
        ...
        n.cssMode && o[p]("scroll", e.onScroll),
            n.updateOnWindowResize ? e[u](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", O, !0) : e[u]("observerUpdate", O, !0);
    };
    var _ = {
        attachEvents: function () {
            ...
            (e.onTouchStart = k.bind(e)), (e.onTouchMove = P.bind(e)), (e.onTouchEnd = $.bind(e)), s.cssMode && (e.onScroll = I.bind(e)), (e.onClick = A.bind(e)), n.touch && !z && (t.addEventListener("touchstart", D), (z = !0)), G(e, "on");
        },
        ...
        return function (s = {}) {
            ...
            "object" == typeof n && null !== n
                ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === e[i] && (e[i] = {auto: !0}),
                    i in e && "enabled" in n ? (!0 === e[i] && (e[i] = {enabled: !0}), "object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = {enabled: !1}), g(t, s)) : g(t, s))
                : g(t, s);
        };
    }
            ...
            loop: {
                ...
                loopFix: function () {
                    ...
                    t < i
                        ...
                        : t >= s.length - i && ((l = -s.length + t + i), (l += i), e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((o ? -e.translate : e.translate) - d)),
                        (e.allowSlidePrev = n),
                        (e.allowSlideNext = r),
                        e.emit("loopFix");
                },
    ...
    class F {
        constructor(...e) {
            let t, s;
            if ((1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? (s = e[0]) : ([t, s] = e), s || (s = {}), (s = g({}, s)), t && !s.el && (s.el = t), s.el && h(s.el).length > 1)) {
                const e = [];
                return (
                    h(s.el).each((t) => {
                        const i = g({}, s, {el: t});
        ...
        slidesPerViewDynamic(e = "current", t = !1) {
            ...
            } else if ("current" === e) for (let e = o + 1; e < i.length; e += 1) (t ? n[e] + r[e] - n[o] < a : n[e] - n[o] < a) && (l += 1);
        ...
        F.use([
            function ({swiper: e, on: t, emit: s}) {
                ...
                t("init", () => {
                    ...
                    t("destroy", () => {
                        a && i.cancelAnimationFrame(a), n && n.unobserve && e.el && (n.unobserve(e.el), (n = null)), i.removeEventListener("resize", o), i.removeEventListener("orientationchange", l);
                    });
            },
    ...
    function R({swiper: e, extendParams: t, on: s, emit: n}) {
        function r(t) {
            let s;
        ...
        function c() {
            ...
            n && n.length > 0 && n.on("click", l),
                Object.assign(e.navigation, {$nextEl: s, nextEl: s && s[0], $prevEl: n, prevEl: n && n[0]}),
            e.enabled || (s && s.addClass(t.lockClass), n && n.addClass(t.lockClass));
        }

        function p() {
            const {$nextEl: t, $prevEl: s} = e.navigation;
            t && t.length && (t.off("click", d), t.removeClass(e.params.navigation.disabledClass)), s && s.length && (s.off("click", l), s.removeClass(e.params.navigation.disabledClass));
        }
    ...
    function X({swiper: e, extendParams: t, on: s}) {
        ...
        function r() {
            ...
            if (null == s) return;
            let n;
            if (((n = t.params.loop ? parseInt(h(t.clickedSlide).attr("data-swiper-slide-index"), 10) : s), e.params.loop)) {
                let t = e.activeIndex;
        ...
        function o(t) {
            ...
            if (
                ...
                for (let t = 0; t < n; t += 1) s.$wrapperEl.children(`[data-swiper-slide-index="${e.realIndex + t}"]`).addClass(r);
            ...
            if (e.realIndex !== s.realIndex || o) {
                ...
                if (s.params.loop) {
                    ...
                    (n = void 0 === t ? i : void 0 === i ? t : i - l == l - t ? (s.params.slidesPerGroup > 1 ? i : l) : i - l < l - t ? i : t), (r = e.activeIndex > e.previousIndex ? "next" : "prev");
                } else (n = e.realIndex), (r = n > e.previousIndex ? "next" : "prev");
                o && (n += "next" === r ? a : -1 * a),
                s.visibleSlidesIndexes &&
                s.visibleSlidesIndexes.indexOf(n) < 0 &&
                (s.params.centeredSlides ? (n = n > l ? n - Math.floor(i / 2) + 1 : n + Math.floor(i / 2) - 1) : n > l && s.params.slidesPerGroup, s.slideTo(n, t ? 0 : void 0));
            }
        }
    ...
    window.addEventListener("DOMContentLoaded", function () {
        ...
        var trigger = document.querySelectorAll("[data-menu-trigger]"),
            menu = document.querySelectorAll("[data-menu-name]"),
            close = document.querySelectorAll(".js-close-menu"),
            hover = {};

        function show(menuName) {
            var t = document.querySelector("[data-menu-trigger=".concat(menuName, "]")),
                s = document.querySelector("[data-menu-name=".concat(menuName, "]"));
            // n();
            t.classList.add("is-show"), s.classList.add("is-show"), window.innerWidth < 1024 && (document.body.style.overflow = "hidden");
        }
        ...
        function hide() {
            trigger.forEach(function (e) {
                var t = document.querySelector("[data-menu-name=".concat(e.dataset.menuTrigger, "]"));
                e.classList.remove("is-show");
                t.classList.remove("is-show");
            }),
            window.innerWidth < 1024 && (document.body.style.overflow = "");
        }

        function delayedHide(){
            setTimeout(function(){
                for(let name in hover){
                    if(hover[name] == false){
                        var t = document.querySelector("[data-menu-trigger=".concat(name, "]")),
                            m = document.querySelector("[data-menu-name=".concat(name, "]"));
                        if(t) t.classList.remove("is-show");
                        if(m) m.classList.remove("is-show");
                        if(t || m) window.innerWidth < 1024 && (document.body.style.overflow = "");
                    }
                }
            }, 3000);
        }
        ...
        trigger.forEach(function (e) {
            e.addEventListener("click", function (t) {
                e.classList.contains("is-show") ? hide() : show(e.dataset.menuTrigger);
            }),
                e.addEventListener("mouseenter", function (t) {
                    hover[e.dataset.menuTrigger] = true;
                    show(e.dataset.menuTrigger);
                }),
                e.addEventListener("mouseleave", function (t) {
                    hover[e.dataset.menuTrigger] = false;
                    delayedHide();
                });
        }),
            menu.forEach(function (e) {
                e.addEventListener("mouseenter", function (t) {
                    hover[e.dataset.menuName] = true;
                });
                e.addEventListener("mouseleave", function (t) {
                    hover[e.dataset.menuName] = false;
                    delayedHide();
                });
            }),
            ...
            document.addEventListener("keydown", function (t) {
                if ("Escape" === t.code)
                    for (var s = 0; s < trigger.length; s++)
                        if (trigger[s].classList.contains("is-show")) {
                            hide();
                            break;
                        }
            }),
            document.addEventListener("mousedown", function (s) {
                for (var i = !1, r = 0; r < trigger.length; r++)
                    if (trigger[r].contains(s.target)) {
                        i = !0;
                        break;
                    }
                for (var a = 0; a < menu.length; a++)
                    if (menu[a].contains(s.target)) {
                        i = !0;
                        break;
                    }
                i || hide();
            });
        var r = document.querySelectorAll(".js-language-menu-item"),
            a = document.querySelector(".js-language-btn");
        r.forEach(function (e) {
            e.addEventListener("change", function () {
                var e = document.querySelector(".js-language-menu-item:checked");
                a.textContent = e.value;
            });
        });
        var o = document.querySelector(".js-header-input"),
            l = document.querySelector(".js-header-input-hints");

        function d() {
            l.classList.add("is-show"), window.innerWidth < 1024 && (document.body.style.overflow = "hidden");
        }

        function c() {
            l.classList.remove("is-show"), window.innerWidth < 1024 && (document.body.style.overflow = "");
        }
        ...
        o.addEventListener("focus", function () {
            ...
            o.addEventListener("input", function () {
                "" != o.value.trim() ? d() : l.classList.contains("is-show") && c();
            }),
            o.addEventListener("blur", function () {
                l.classList.contains("is-show") && c();
            }),
            new W(".partners__slider", {
                modules: [R],
                slidesPerView: 1.2,
                spaceBetween: 12,
                speed: 800,
                ...
                centeredSlides: !0,
                navigation: {
                    nextEl: ".partners__brands .swiper-button-next",
                    prevEl: ".partners__brands .swiper-button-prev"
                },
                breakpoints: {768: {slidesPerView: 3, spaceBetween: 32}},
            });
        var p = new W(".product__thumbs-slider", {slidesPerView: 4, speed: 500});
        new W(".product__main-slider", {modules: [X], slidesPerView: 1, speed: 500, thumbs: {swiper: p}});
        var u = document.getElementById("requestFile");
        if (u) {
            u.addEventListener("dragenter", function (e) {
                e.preventDefault(), u.classList.add("hover");
            }),
                u.addEventListener("dragover", function (e) {
                    e.preventDefault(), u.classList.add("hover");
                }),
                u.addEventListener("dragleave", function (e) {
                    e.preventDefault(), u.classList.remove("hover");
                });
            var h = document.querySelector("#requestFile + label .js-request-label-title");
            u.addEventListener("drop", function (e) {
                e.preventDefault();
                var t = e.dataTransfer.files;
                u.setAttribute("value", ""), (u.files = t), u.classList.remove("hover"), "" != u.value && (h.innerText = u.files[0].name);
            }),
                u.addEventListener("input", function () {
                    "" != u.value && (h.innerText = u.files[0].name);
                });
        }
        var f = document.querySelectorAll("[data-modal]"),
            m = document.querySelectorAll(".js-modal"),
            v = document.querySelectorAll(".js-close-modal-btn");
        ...
        f.forEach(function (e) {
            e.addEventListener("click", function (e) {
                return (function (e) {
                    ...
                    "" != t.dataset.modal && (document.querySelector("[data-name=".concat(t.dataset.modal, "]")).classList.add("show"), (document.body.style.overflow = "hidden"));
                })(e);
            });
        }),
        v &&
        v.forEach(function (e) {
            ...
            document.addEventListener("keydown", function (e) {
                "Escape" === e.code &&
                m.forEach(function (e) {
                    e.classList.contains("show") && g();
                });
            });
        var w = document.querySelectorAll(".js-modal-content");
        document.addEventListener("mousedown", function (e) {
            var t = !1;
            w &&
            w.forEach(function (s) {
                s.contains(e.target) && (t = !0);
            }),
            t || g();
        });
    });
