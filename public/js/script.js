!(function () {
    ...
    window.addEventListener("DOMContentLoaded", function () {
        ...
        var e = document.querySelectorAll("[data-menu-trigger]"),
            t = document.querySelectorAll("[data-menu-name]"),
            s = document.querySelectorAll(".js-close-menu");

        function i(e) {
            var t = e.currentTarget,
                s = document.querySelector("[data-menu-name=".concat(t.dataset.menuTrigger, "]"));
            // n();
        ...
        e.forEach(function (e) {
            e.addEventListener("click", function (t) {
                e.classList.contains("is-show") ? n() : i(t);
            }),
                e.addEventListener("mouseenter", function (t) {
                    !e.classList.contains("is-show") && document.documentElement.clientWidth >= 1024 && i(t);
                }),
                e.addEventListener("mouseleave", function (e) {
                    setTimeout(function () {
                        e.currentTarget.dataset.menuTrigger != e.relatedTarget.dataset.menuName && document.documentElement.clientWidth >= 1024 && n();
                    }, 2500);
                });
        }),
            t.forEach(function (e) {
                e.addEventListener("mouseleave", function (e) {
                    setTimeout(function () {
                        document.documentElement.clientWidth >= 1024 && n();
                    }, 2500);
                });
            }),
            ...
            document.addEventListener("keydown", function (t) {
                if ("Escape" === t.code)
                    for (var s = 0; s < e.length; s++)
                        if (e[s].classList.contains("is-show")) {
                            n();
                            break;
                        }
            }),
            document.addEventListener("mousedown", function (s) {
                for (var i = !1, r = 0; r < e.length; r++)
                    if (e[r].contains(s.target)) {
                        i = !0;
                        break;
                    }
                for (var a = 0; a < t.length; a++)
                    if (t[a].contains(s.target)) {
                        i = !0;
                        break;
                    }
                i || n();
