            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        {!! Form::open(['url' => URL::route('cp.photos.update'), 'method' => 'put', 'files' => true, 'class' => "smart-form"]) !!}
                        ...
                        <footer>
                            ...
                            <a class="btn btn-default" href="{{ URL::route('cp.photos.index', ['photoalbum_id' => $row->photoalbum_id]) }}">
                                Назад
                            </a>
                        </footer>
