            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        {!! Form::open(['url' => isset($row) ? URL::route('cp.users.update') : URL::route('cp.users.store'), 'method' => isset($row) ? 'put' : 'post', 'class' => "smart-form"]) !!}
                        ...
                        <footer>
                            ...
                            <a class="btn btn-default" href="{{ URL::route('cp.users.index') }}">
                                Назад
                            </a>
                        </footer>
