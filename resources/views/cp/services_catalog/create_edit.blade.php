            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        {!! Form::open(['url' => isset($row) ? URL::route('cp.services_catalog.update') : URL::route('cp.services_catalog.store'), 'files' => true, 'method' => isset($row) ? 'put' : 'post', 'class' => "smart-form"]) !!}
                        ...
                        <footer>
                            ...
                            <a class="btn btn-default" href="{{ URL::route('cp.services_catalog.index') }}">
                                Назад
                            </a>
                        </footer>
            ...
            $("#name").on("change keyup input click", function () {
                if (this.value.length >= 2) {
                    ...
                    let request = $.ajax({
                        ...
                        method: "POST",
                        data: {
                            action: "get_services_catalog_slug",
                            name: name
                        },
